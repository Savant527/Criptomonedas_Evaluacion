...
<br>
<!-- TABLA -->
<td><a href="http://localhost/criptomonedas/registro_cripto.php" class="btn btn-dark">Crear Criptomoneda</a></td>
...
<tr> <td><?php echo $mostrar['id'] ?>
  ...
  <td> <a class="m-1 btn btn-warning" href="./editar_cripto.php?id=<?php echo $mostrar['id']?>">Editar</a></td>
    <td><a href="./eliminar_cripto.php?id=<?php echo $mostrar['id']; ?>" class="btn btn-danger">Eliminar</a></td>
</tr>
<?php
}
